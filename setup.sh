...
# https://raw.githubusercontent.com/Andyyuda/v5/main/izin 
...
echo -e "${tyblue} Welcome To AutoScript......${NC} "
sleep 2
...
wget -q -O /usr/bin/add-ws "https://raw.githubusercontent.com/Andyyuda/v5/main/add-ws.sh"
